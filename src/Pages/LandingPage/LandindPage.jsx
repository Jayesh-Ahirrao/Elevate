      ...
      <main className="main-content">
        <section className="hero-section">
          <h1 className="hero-Welcome">
            Welcome to{" "}
            <span style={{ color: "#38bff0", letterSpacing: "-4px", fontFamily: "League Spartan"}}>
              elevate
            </span>
          </h1>
        ...
        <section className="featured-jobs">
          ...
          <div className="job-grid">
            {featuredJobs.map((job, index) => <JobCard key={index} {...job} />)}
          </div>
        </section>

        <section className="info-section">
          <h2>
            Why Choose <span style={{ letterSpacing: "-3px", fontFamily: "League Spartan" }}>elevate</span> ?
          </h2>
        ...
        <section className="thank-you">
          <h2>
            ...
            <span style={{ fontFamily: "League Spartan", fontWeight: "bold" }}>us :)</span>
          </h2>
          <p>
